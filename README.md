...
```bash
git clone git@github.com:Hariom9991/llm_quiz_solver.git
cd llm_quiz_solver
```
...
For questions or issues, please open an issue on the [GitHub repository](https://github.com/Hariom9991/llm_quiz_solver).